...
GraphicsEngine::GraphicsEngine(ContextManager *pContextManager) :
...
void GraphicsEngine::Draw(DemoCore* pCore)
{
	...
	pContextManager->DrawOverlayElements();
}
...
void GraphicsEngine::DrawScene(DemoCore* pCore)
{
